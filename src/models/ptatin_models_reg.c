...
extern PetscErrorCode pTatinModelRegister_Rift3D_TFV(void);
...
extern PetscErrorCode pTatinModelRegister_SubductionOblique(void);
...
extern PetscErrorCode pTatinModelRegister_Debug(void);
...
PetscErrorCode pTatinModelRegisterAll(void)
{
  ...
  ierr = pTatinModelRegister_Rift3D_TFV();CHKERRQ(ierr);
  ...
  ierr = pTatinModelRegister_SubductionOblique();CHKERRQ(ierr);
  ierr = pTatinModelRegister_Steady_TFV();CHKERRQ(ierr);
  ierr = pTatinModelRegister_Debug();CHKERRQ(ierr);
