...
double scale, double F[])
{
  ...
  double aux9 = 2.0*u1j_udNx1j;
  double aux10 = 1.0*u0j_udNx1j;
  double aux11 = 1.0*u1j_udNx0j;
  double aux12 = 2.0*u2j_udNx2j;
  double aux13 = pow(L_J[0], 2)*n[0];
  double aux14 = aux13*tau_S[3];
  double aux15 = pow(L_J[1], 2)*n[1];
  double aux16 = aux15*tau_S[1];
  double aux17 = pow(L_J[2], 2)*n[2];
  double aux18 = aux17*tau_S[5];
  double aux19 = aux17*tau_S[2];
  double aux20 = pow(L_I[0], 2);
  double aux21 = aux10*aux13;
  double aux22 = 1.0*aux13;
  double aux23 = aux22*u1j_udNx0j;
  double aux24 = aux15*aux9;
  double aux25 = 1.0*aux17;
  double aux26 = aux22*u0j_udNx2j;
  double aux27 = aux22*u2j_udNx0j;
  double aux28 = 1.0*aux15;
  double aux29 = aux12*aux17;
  double aux30 = 2.0*u0j_udNx0j;
  double aux31 = aux13*aux30;
  double aux32 = aux28*u0j_udNx1j;
  double aux33 = aux28*u1j_udNx0j;
  double aux34 = L_I[1]*L_I[2];
  double aux35 = aux13*tau_S[0];
  double aux36 = aux15*tau_S[3];
  double aux37 = pow(L_I[1], 2);
  double aux38 = pow(L_I[2], 2);
  for (i=0; i<27; i++) { // w_nbasis
    
    __Fi[0] = H_IJ*L_I[0]*L_I[1]*aux1*aux9*eta*wNt[i] - H_IJ*L_I[0]*L_I[1]*aux1*tau_S[1]*wNt[i] + H_IJ*L_I[0]*L_I[1]*aux10*aux2*eta*wNt[i] + H_IJ*L_I[0]*L_I[1]*aux10*aux5*eta*wNt[i] + H_IJ*L_I[0]*L_I[1]*aux11*aux2*eta*wNt[i] + H_IJ*L_I[0]*L_I[1]*aux11*aux5*eta*wNt[i] - H_IJ*L_I[0]*L_I[1]*aux14*wNt[i] - H_IJ*L_I[0]*L_I[1]*aux16*wNt[i] - H_IJ*L_I[0]*L_I[1]*aux18*wNt[i] - H_IJ*L_I[0]*L_I[1]*aux2*tau_S[3]*wNt[i] + H_IJ*L_I[0]*L_I[1]*aux21*eta*wNt[i] + H_IJ*L_I[0]*L_I[1]*aux23*eta*wNt[i] + H_IJ*L_I[0]*L_I[1]*aux24*eta*wNt[i] + H_IJ*L_I[0]*L_I[1]*aux25*eta*u1j_udNx2j*wNt[i] + H_IJ*L_I[0]*L_I[1]*aux25*eta*u2j_udNx1j*wNt[i] + 1.0*H_IJ*L_I[0]*L_I[1]*aux4*eta*u1j_udNx2j*wNt[i] + 1.0*H_IJ*L_I[0]*L_I[1]*aux4*eta*u2j_udNx1j*wNt[i] - H_IJ*L_I[0]*L_I[1]*aux4*tau_S[5]*wNt[i] - H_IJ*L_I[0]*L_I[1]*aux5*tau_S[3]*wNt[i] + 1.0*H_IJ*L_I[0]*L_I[1]*aux7*eta*u1j_udNx2j*wNt[i] + 1.0*H_IJ*L_I[0]*L_I[1]*aux7*eta*u2j_udNx1j*wNt[i] - H_IJ*L_I[0]*L_I[1]*aux7*tau_S[5]*wNt[i] + H_IJ*L_I[0]*L_I[1]*aux8*aux9*eta*wNt[i] - H_IJ*L_I[0]*L_I[1]*aux8*tau_S[1]*wNt[i] + 1.0*H_IJ*L_I[0]*L_I[2]*aux1*eta*u1j_udNx2j*wNt[i] + 1.0*H_IJ*L_I[0]*L_I[2]*aux1*eta*u2j_udNx1j*wNt[i] - H_IJ*L_I[0]*L_I[2]*aux1*tau_S[4]*wNt[i] + H_IJ*L_I[0]*L_I[2]*aux12*aux4*eta*wNt[i] + H_IJ*L_I[0]*L_I[2]*aux12*aux7*eta*wNt[i] - H_IJ*L_I[0]*L_I[2]*aux13*tau_S[4]*wNt[i] - H_IJ*L_I[0]*L_I[2]*aux15*tau_S[4]*wNt[i] - H_IJ*L_I[0]*L_I[2]*aux19*wNt[i] + 1.0*H_IJ*L_I[0]*L_I[2]*aux2*eta*u0j_udNx2j*wNt[i] + 1.0*H_IJ*L_I[0]*L_I[2]*aux2*eta*u2j_udNx0j*wNt[i] - H_IJ*L_I[0]*L_I[2]*aux2*tau_S[4]*wNt[i] + H_IJ*L_I[0]*L_I[2]*aux26*eta*wNt[i] + H_IJ*L_I[0]*L_I[2]*aux27*eta*wNt[i] + H_IJ*L_I[0]*L_I[2]*aux28*eta*u1j_udNx2j*wNt[i] + H_IJ*L_I[0]*L_I[2]*aux28*eta*u2j_udNx1j*wNt[i] + H_IJ*L_I[0]*L_I[2]*aux29*eta*wNt[i] - H_IJ*L_I[0]*L_I[2]*aux4*tau_S[2]*wNt[i] + 1.0*H_IJ*L_I[0]*L_I[2]*aux5*eta*u0j_udNx2j*wNt[i] + 1.0*H_IJ*L_I[0]*L_I[2]*aux5*eta*u2j_udNx0j*wNt[i] - H_IJ*L_I[0]*L_I[2]*aux5*tau_S[4]*wNt[i] - H_IJ*L_I[0]*L_I[2]*aux7*tau_S[2]*wNt[i] + 1.0*H_IJ*L_I[0]*L_I[2]*aux8*eta*u1j_udNx2j*wNt[i] + 1.0*H_IJ*L_I[0]*L_I[2]*aux8*eta*u2j_udNx1j*wNt[i] - H_IJ*L_I[0]*L_I[2]*aux8*tau_S[4]*wNt[i] + H_IJ*aux1*aux10*aux20*eta*wNt[i] + H_IJ*aux1*aux11*aux20*eta*wNt[i] - H_IJ*aux1*aux20*tau_S[3]*wNt[i] + H_IJ*aux10*aux20*aux8*eta*wNt[i] + H_IJ*aux11*aux20*aux8*eta*wNt[i] - H_IJ*aux13*aux20*tau_S[0]*wNt[i] - H_IJ*aux15*aux20*tau_S[3]*wNt[i] - H_IJ*aux17*aux20*tau_S[4]*wNt[i] + H_IJ*aux2*aux20*aux30*eta*wNt[i] - H_IJ*aux2*aux20*tau_S[0]*wNt[i] + H_IJ*aux20*aux25*eta*u0j_udNx2j*wNt[i] + H_IJ*aux20*aux25*eta*u2j_udNx0j*wNt[i] + H_IJ*aux20*aux30*aux5*eta*wNt[i] + H_IJ*aux20*aux31*eta*wNt[i] + H_IJ*aux20*aux32*eta*wNt[i] + H_IJ*aux20*aux33*eta*wNt[i] + 1.0*H_IJ*aux20*aux4*eta*u0j_udNx2j*wNt[i] + 1.0*H_IJ*aux20*aux4*eta*u2j_udNx0j*wNt[i] - H_IJ*aux20*aux4*tau_S[4]*wNt[i] - H_IJ*aux20*aux5*tau_S[0]*wNt[i] + 1.0*H_IJ*aux20*aux7*eta*u0j_udNx2j*wNt[i] + 1.0*H_IJ*aux20*aux7*eta*u2j_udNx0j*wNt[i] - H_IJ*aux20*aux7*tau_S[4]*wNt[i] - H_IJ*aux20*aux8*tau_S[3]*wNt[i] - L_I[0]*L_I[1]*aux1*aux9*eta*wNt[i] - L_I[0]*L_I[1]*aux10*aux2*eta*wNt[i] - L_I[0]*L_I[1]*aux10*aux5*eta*wNt[i] - L_I[0]*L_I[1]*aux11*aux2*eta*wNt[i] - L_I[0]*L_I[1]*aux11*aux5*eta*wNt[i] - L_I[0]*L_I[1]*aux21*eta*wNt[i] - L_I[0]*L_I[1]*aux23*eta*wNt[i] - L_I[0]*L_I[1]*aux24*eta*wNt[i] - L_I[0]*L_I[1]*aux25*eta*u1j_udNx2j*wNt[i] - L_I[0]*L_I[1]*aux25*eta*u2j_udNx1j*wNt[i] - 1.0*L_I[0]*L_I[1]*aux4*eta*u1j_udNx2j*wNt[i] - 1.0*L_I[0]*L_I[1]*aux4*eta*u2j_udNx1j*wNt[i] - 1.0*L_I[0]*L_I[1]*aux7*eta*u1j_udNx2j*wNt[i] - 1.0*L_I[0]*L_I[1]*aux7*eta*u2j_udNx1j*wNt[i] - L_I[0]*L_I[1]*aux8*aux9*eta*wNt[i] - 1.0*L_I[0]*L_I[2]*aux1*eta*u1j_udNx2j*wNt[i] - 1.0*L_I[0]*L_I[2]*aux1*eta*u2j_udNx1j*wNt[i] - L_I[0]*L_I[2]*aux12*aux4*eta*wNt[i] - L_I[0]*L_I[2]*aux12*aux7*eta*wNt[i] - 1.0*L_I[0]*L_I[2]*aux2*eta*u0j_udNx2j*wNt[i] - 1.0*L_I[0]*L_I[2]*aux2*eta*u2j_udNx0j*wNt[i] - L_I[0]*L_I[2]*aux26*eta*wNt[i] - L_I[0]*L_I[2]*aux27*eta*wNt[i] - L_I[0]*L_I[2]*aux28*eta*u1j_udNx2j*wNt[i] - L_I[0]*L_I[2]*aux28*eta*u2j_udNx1j*wNt[i] - L_I[0]*L_I[2]*aux29*eta*wNt[i] - 1.0*L_I[0]*L_I[2]*aux5*eta*u0j_udNx2j*wNt[i] - 1.0*L_I[0]*L_I[2]*aux5*eta*u2j_udNx0j*wNt[i] - 1.0*L_I[0]*L_I[2]*aux8*eta*u1j_udNx2j*wNt[i] - 1.0*L_I[0]*L_I[2]*aux8*eta*u2j_udNx1j*wNt[i] - aux1*aux10*aux20*eta*wNt[i] - aux1*aux11*aux20*eta*wNt[i] - aux10*aux20*aux8*eta*wNt[i] - aux11*aux20*aux8*eta*wNt[i] - aux2*aux20*aux30*eta*wNt[i] - aux20*aux25*eta*u0j_udNx2j*wNt[i] - aux20*aux25*eta*u2j_udNx0j*wNt[i] - aux20*aux30*aux5*eta*wNt[i] - aux20*aux31*eta*wNt[i] - aux20*aux32*eta*wNt[i] - aux20*aux33*eta*wNt[i] - 1.0*aux20*aux4*eta*u0j_udNx2j*wNt[i] - 1.0*aux20*aux4*eta*u2j_udNx0j*wNt[i] - 1.0*aux20*aux7*eta*u0j_udNx2j*wNt[i] - 1.0*aux20*aux7*eta*u2j_udNx0j*wNt[i];
    __Fi[1] = H_IJ*L_I[0]*L_I[1]*aux1*aux10*eta*wNt[i] + H_IJ*L_I[0]*L_I[1]*aux1*aux11*eta*wNt[i] - H_IJ*L_I[0]*L_I[1]*aux1*tau_S[3]*wNt[i] + H_IJ*L_I[0]*L_I[1]*aux10*aux8*eta*wNt[i] + H_IJ*L_I[0]*L_I[1]*aux11*aux8*eta*wNt[i] - H_IJ*L_I[0]*L_I[1]*aux17*tau_S[4]*wNt[i] + H_IJ*L_I[0]*L_I[1]*aux2*aux30*eta*wNt[i] - H_IJ*L_I[0]*L_I[1]*aux2*tau_S[0]*wNt[i] + H_IJ*L_I[0]*L_I[1]*aux25*eta*u0j_udNx2j*wNt[i] + H_IJ*L_I[0]*L_I[1]*aux25*eta*u2j_udNx0j*wNt[i] + H_IJ*L_I[0]*L_I[1]*aux30*aux5*eta*wNt[i] + H_IJ*L_I[0]*L_I[1]*aux31*eta*wNt[i] + H_IJ*L_I[0]*L_I[1]*aux32*eta*wNt[i] + H_IJ*L_I[0]*L_I[1]*aux33*eta*wNt[i] - H_IJ*L_I[0]*L_I[1]*aux35*wNt[i] - H_IJ*L_I[0]*L_I[1]*aux36*wNt[i] + 1.0*H_IJ*L_I[0]*L_I[1]*aux4*eta*u0j_udNx2j*wNt[i] + 1.0*H_IJ*L_I[0]*L_I[1]*aux4*eta*u2j_udNx0j*wNt[i] - H_IJ*L_I[0]*L_I[1]*aux4*tau_S[4]*wNt[i] - H_IJ*L_I[0]*L_I[1]*aux5*tau_S[0]*wNt[i] + 1.0*H_IJ*L_I[0]*L_I[1]*aux7*eta*u0j_udNx2j*wNt[i] + 1.0*H_IJ*L_I[0]*L_I[1]*aux7*eta*u2j_udNx0j*wNt[i] - H_IJ*L_I[0]*L_I[1]*aux7*tau_S[4]*wNt[i] - H_IJ*L_I[0]*L_I[1]*aux8*tau_S[3]*wNt[i] + 1.0*H_IJ*aux1*aux34*eta*u1j_udNx2j*wNt[i] + 1.0*H_IJ*aux1*aux34*eta*u2j_udNx1j*wNt[i] - H_IJ*aux1*aux34*tau_S[4]*wNt[i] + H_IJ*aux1*aux37*aux9*eta*wNt[i] - H_IJ*aux1*aux37*tau_S[1]*wNt[i] + H_IJ*aux10*aux2*aux37*eta*wNt[i] + H_IJ*aux10*aux37*aux5*eta*wNt[i] + H_IJ*aux11*aux2*aux37*eta*wNt[i] + H_IJ*aux11*aux37*aux5*eta*wNt[i] + H_IJ*aux12*aux34*aux4*eta*wNt[i] + H_IJ*aux12*aux34*aux7*eta*wNt[i] - H_IJ*aux13*aux34*tau_S[4]*wNt[i] - H_IJ*aux14*aux37*wNt[i] - H_IJ*aux15*aux34*tau_S[4]*wNt[i] - H_IJ*aux16*aux37*wNt[i] - H_IJ*aux18*aux37*wNt[i] - H_IJ*aux19*aux34*wNt[i] + 1.0*H_IJ*aux2*aux34*eta*u0j_udNx2j*wNt[i] + 1.0*H_IJ*aux2*aux34*eta*u2j_udNx0j*wNt[i] - H_IJ*aux2*aux34*tau_S[4]*wNt[i] - H_IJ*aux2*aux37*tau_S[3]*wNt[i] + H_IJ*aux21*aux37*eta*wNt[i] + H_IJ*aux23*aux37*eta*wNt[i] + H_IJ*aux24*aux37*eta*wNt[i] + H_IJ*aux25*aux37*eta*u1j_udNx2j*wNt[i] + H_IJ*aux25*aux37*eta*u2j_udNx1j*wNt[i] + H_IJ*aux26*aux34*eta*wNt[i] + H_IJ*aux27*aux34*eta*wNt[i] + H_IJ*aux28*aux34*eta*u1j_udNx2j*wNt[i] + H_IJ*aux28*aux34*eta*u2j_udNx1j*wNt[i] + H_IJ*aux29*aux34*eta*wNt[i] - H_IJ*aux34*aux4*tau_S[2]*wNt[i] + 1.0*H_IJ*aux34*aux5*eta*u0j_udNx2j*wNt[i] + 1.0*H_IJ*aux34*aux5*eta*u2j_udNx0j*wNt[i] - H_IJ*aux34*aux5*tau_S[4]*wNt[i] - H_IJ*aux34*aux7*tau_S[2]*wNt[i] + 1.0*H_IJ*aux34*aux8*eta*u1j_udNx2j*wNt[i] + 1.0*H_IJ*aux34*aux8*eta*u2j_udNx1j*wNt[i] - H_IJ*aux34*aux8*tau_S[4]*wNt[i] + 1.0*H_IJ*aux37*aux4*eta*u1j_udNx2j*wNt[i] + 1.0*H_IJ*aux37*aux4*eta*u2j_udNx1j*wNt[i] - H_IJ*aux37*aux4*tau_S[5]*wNt[i] - H_IJ*aux37*aux5*tau_S[3]*wNt[i] + 1.0*H_IJ*aux37*aux7*eta*u1j_udNx2j*wNt[i] + 1.0*H_IJ*aux37*aux7*eta*u2j_udNx1j*wNt[i] - H_IJ*aux37*aux7*tau_S[5]*wNt[i] + H_IJ*aux37*aux8*aux9*eta*wNt[i] - H_IJ*aux37*aux8*tau_S[1]*wNt[i] - L_I[0]*L_I[1]*aux1*aux10*eta*wNt[i] - L_I[0]*L_I[1]*aux1*aux11*eta*wNt[i] - L_I[0]*L_I[1]*aux10*aux8*eta*wNt[i] - L_I[0]*L_I[1]*aux11*aux8*eta*wNt[i] - L_I[0]*L_I[1]*aux2*aux30*eta*wNt[i] - L_I[0]*L_I[1]*aux25*eta*u0j_udNx2j*wNt[i] - L_I[0]*L_I[1]*aux25*eta*u2j_udNx0j*wNt[i] - L_I[0]*L_I[1]*aux30*aux5*eta*wNt[i] - L_I[0]*L_I[1]*aux31*eta*wNt[i] - L_I[0]*L_I[1]*aux32*eta*wNt[i] - L_I[0]*L_I[1]*aux33*eta*wNt[i] - 1.0*L_I[0]*L_I[1]*aux4*eta*u0j_udNx2j*wNt[i] - 1.0*L_I[0]*L_I[1]*aux4*eta*u2j_udNx0j*wNt[i] - 1.0*L_I[0]*L_I[1]*aux7*eta*u0j_udNx2j*wNt[i] - 1.0*L_I[0]*L_I[1]*aux7*eta*u2j_udNx0j*wNt[i] - 1.0*aux1*aux34*eta*u1j_udNx2j*wNt[i] - 1.0*aux1*aux34*eta*u2j_udNx1j*wNt[i] - aux1*aux37*aux9*eta*wNt[i] - aux10*aux2*aux37*eta*wNt[i] - aux10*aux37*aux5*eta*wNt[i] - aux11*aux2*aux37*eta*wNt[i] - aux11*aux37*aux5*eta*wNt[i] - aux12*aux34*aux4*eta*wNt[i] - aux12*aux34*aux7*eta*wNt[i] - 1.0*aux2*aux34*eta*u0j_udNx2j*wNt[i] - 1.0*aux2*aux34*eta*u2j_udNx0j*wNt[i] - aux21*aux37*eta*wNt[i] - aux23*aux37*eta*wNt[i] - aux24*aux37*eta*wNt[i] - aux25*aux37*eta*u1j_udNx2j*wNt[i] - aux25*aux37*eta*u2j_udNx1j*wNt[i] - aux26*aux34*eta*wNt[i] - aux27*aux34*eta*wNt[i] - aux28*aux34*eta*u1j_udNx2j*wNt[i] - aux28*aux34*eta*u2j_udNx1j*wNt[i] - aux29*aux34*eta*wNt[i] - 1.0*aux34*aux5*eta*u0j_udNx2j*wNt[i] - 1.0*aux34*aux5*eta*u2j_udNx0j*wNt[i] - 1.0*aux34*aux8*eta*u1j_udNx2j*wNt[i] - 1.0*aux34*aux8*eta*u2j_udNx1j*wNt[i] - 1.0*aux37*aux4*eta*u1j_udNx2j*wNt[i] - 1.0*aux37*aux4*eta*u2j_udNx1j*wNt[i] - 1.0*aux37*aux7*eta*u1j_udNx2j*wNt[i] - 1.0*aux37*aux7*eta*u2j_udNx1j*wNt[i] - aux37*aux8*aux9*eta*wNt[i];
    __Fi[2] = H_IJ*L_I[0]*L_I[2]*aux1*aux10*eta*wNt[i] + H_IJ*L_I[0]*L_I[2]*aux1*aux11*eta*wNt[i] - H_IJ*L_I[0]*L_I[2]*aux1*tau_S[3]*wNt[i] + H_IJ*L_I[0]*L_I[2]*aux10*aux8*eta*wNt[i] + H_IJ*L_I[0]*L_I[2]*aux11*aux8*eta*wNt[i] - H_IJ*L_I[0]*L_I[2]*aux17*tau_S[4]*wNt[i] + H_IJ*L_I[0]*L_I[2]*aux2*aux30*eta*wNt[i] - H_IJ*L_I[0]*L_I[2]*aux2*tau_S[0]*wNt[i] + H_IJ*L_I[0]*L_I[2]*aux25*eta*u0j_udNx2j*wNt[i] + H_IJ*L_I[0]*L_I[2]*aux25*eta*u2j_udNx0j*wNt[i] + H_IJ*L_I[0]*L_I[2]*aux30*aux5*eta*wNt[i] + H_IJ*L_I[0]*L_I[2]*aux31*eta*wNt[i] + H_IJ*L_I[0]*L_I[2]*aux32*eta*wNt[i] + H_IJ*L_I[0]*L_I[2]*aux33*eta*wNt[i] - H_IJ*L_I[0]*L_I[2]*aux35*wNt[i] - H_IJ*L_I[0]*L_I[2]*aux36*wNt[i] + 1.0*H_IJ*L_I[0]*L_I[2]*aux4*eta*u0j_udNx2j*wNt[i] + 1.0*H_IJ*L_I[0]*L_I[2]*aux4*eta*u2j_udNx0j*wNt[i] - H_IJ*L_I[0]*L_I[2]*aux4*tau_S[4]*wNt[i] - H_IJ*L_I[0]*L_I[2]*aux5*tau_S[0]*wNt[i] + 1.0*H_IJ*L_I[0]*L_I[2]*aux7*eta*u0j_udNx2j*wNt[i] + 1.0*H_IJ*L_I[0]*L_I[2]*aux7*eta*u2j_udNx0j*wNt[i] - H_IJ*L_I[0]*L_I[2]*aux7*tau_S[4]*wNt[i] - H_IJ*L_I[0]*L_I[2]*aux8*tau_S[3]*wNt[i] + H_IJ*aux1*aux34*aux9*eta*wNt[i] - H_IJ*aux1*aux34*tau_S[1]*wNt[i] + 1.0*H_IJ*aux1*aux38*eta*u1j_udNx2j*wNt[i] + 1.0*H_IJ*aux1*aux38*eta*u2j_udNx1j*wNt[i] - H_IJ*aux1*aux38*tau_S[4]*wNt[i] + H_IJ*aux10*aux2*aux34*eta*wNt[i] + H_IJ*aux10*aux34*aux5*eta*wNt[i] + H_IJ*aux11*aux2*aux34*eta*wNt[i] + H_IJ*aux11*aux34*aux5*eta*wNt[i] + H_IJ*aux12*aux38*aux4*eta*wNt[i] + H_IJ*aux12*aux38*aux7*eta*wNt[i] - H_IJ*aux13*aux38*tau_S[4]*wNt[i] - H_IJ*aux14*aux34*wNt[i] - H_IJ*aux15*aux38*tau_S[4]*wNt[i] - H_IJ*aux16*aux34*wNt[i] - H_IJ*aux18*aux34*wNt[i] - H_IJ*aux19*aux38*wNt[i] - H_IJ*aux2*aux34*tau_S[3]*wNt[i] + 1.0*H_IJ*aux2*aux38*eta*u0j_udNx2j*wNt[i] + 1.0*H_IJ*aux2*aux38*eta*u2j_udNx0j*wNt[i] - H_IJ*aux2*aux38*tau_S[4]*wNt[i] + H_IJ*aux21*aux34*eta*wNt[i] + H_IJ*aux23*aux34*eta*wNt[i] + H_IJ*aux24*aux34*eta*wNt[i] + H_IJ*aux25*aux34*eta*u1j_udNx2j*wNt[i] + H_IJ*aux25*aux34*eta*u2j_udNx1j*wNt[i] + H_IJ*aux26*aux38*eta*wNt[i] + H_IJ*aux27*aux38*eta*wNt[i] + H_IJ*aux28*aux38*eta*u1j_udNx2j*wNt[i] + H_IJ*aux28*aux38*eta*u2j_udNx1j*wNt[i] + H_IJ*aux29*aux38*eta*wNt[i] + 1.0*H_IJ*aux34*aux4*eta*u1j_udNx2j*wNt[i] + 1.0*H_IJ*aux34*aux4*eta*u2j_udNx1j*wNt[i] - H_IJ*aux34*aux4*tau_S[5]*wNt[i] - H_IJ*aux34*aux5*tau_S[3]*wNt[i] + 1.0*H_IJ*aux34*aux7*eta*u1j_udNx2j*wNt[i] + 1.0*H_IJ*aux34*aux7*eta*u2j_udNx1j*wNt[i] - H_IJ*aux34*aux7*tau_S[5]*wNt[i] + H_IJ*aux34*aux8*aux9*eta*wNt[i] - H_IJ*aux34*aux8*tau_S[1]*wNt[i] - H_IJ*aux38*aux4*tau_S[2]*wNt[i] + 1.0*H_IJ*aux38*aux5*eta*u0j_udNx2j*wNt[i] + 1.0*H_IJ*aux38*aux5*eta*u2j_udNx0j*wNt[i] - H_IJ*aux38*aux5*tau_S[4]*wNt[i] - H_IJ*aux38*aux7*tau_S[2]*wNt[i] + 1.0*H_IJ*aux38*aux8*eta*u1j_udNx2j*wNt[i] + 1.0*H_IJ*aux38*aux8*eta*u2j_udNx1j*wNt[i] - H_IJ*aux38*aux8*tau_S[4]*wNt[i] - L_I[0]*L_I[2]*aux1*aux10*eta*wNt[i] - L_I[0]*L_I[2]*aux1*aux11*eta*wNt[i] - L_I[0]*L_I[2]*aux10*aux8*eta*wNt[i] - L_I[0]*L_I[2]*aux11*aux8*eta*wNt[i] - L_I[0]*L_I[2]*aux2*aux30*eta*wNt[i] - L_I[0]*L_I[2]*aux25*eta*u0j_udNx2j*wNt[i] - L_I[0]*L_I[2]*aux25*eta*u2j_udNx0j*wNt[i] - L_I[0]*L_I[2]*aux30*aux5*eta*wNt[i] - L_I[0]*L_I[2]*aux31*eta*wNt[i] - L_I[0]*L_I[2]*aux32*eta*wNt[i] - L_I[0]*L_I[2]*aux33*eta*wNt[i] - 1.0*L_I[0]*L_I[2]*aux4*eta*u0j_udNx2j*wNt[i] - 1.0*L_I[0]*L_I[2]*aux4*eta*u2j_udNx0j*wNt[i] - 1.0*L_I[0]*L_I[2]*aux7*eta*u0j_udNx2j*wNt[i] - 1.0*L_I[0]*L_I[2]*aux7*eta*u2j_udNx0j*wNt[i] - aux1*aux34*aux9*eta*wNt[i] - 1.0*aux1*aux38*eta*u1j_udNx2j*wNt[i] - 1.0*aux1*aux38*eta*u2j_udNx1j*wNt[i] - aux10*aux2*aux34*eta*wNt[i] - aux10*aux34*aux5*eta*wNt[i] - aux11*aux2*aux34*eta*wNt[i] - aux11*aux34*aux5*eta*wNt[i] - aux12*aux38*aux4*eta*wNt[i] - aux12*aux38*aux7*eta*wNt[i] - 1.0*aux2*aux38*eta*u0j_udNx2j*wNt[i] - 1.0*aux2*aux38*eta*u2j_udNx0j*wNt[i] - aux21*aux34*eta*wNt[i] - aux23*aux34*eta*wNt[i] - aux24*aux34*eta*wNt[i] - aux25*aux34*eta*u1j_udNx2j*wNt[i] - aux25*aux34*eta*u2j_udNx1j*wNt[i] - aux26*aux38*eta*wNt[i] - aux27*aux38*eta*wNt[i] - aux28*aux38*eta*u1j_udNx2j*wNt[i] - aux28*aux38*eta*u2j_udNx1j*wNt[i] - aux29*aux38*eta*wNt[i] - 1.0*aux34*aux4*eta*u1j_udNx2j*wNt[i] - 1.0*aux34*aux4*eta*u2j_udNx1j*wNt[i] - 1.0*aux34*aux7*eta*u1j_udNx2j*wNt[i] - 1.0*aux34*aux7*eta*u2j_udNx1j*wNt[i] - aux34*aux8*aux9*eta*wNt[i] - 1.0*aux38*aux5*eta*u0j_udNx2j*wNt[i] - 1.0*aux38*aux5*eta*u2j_udNx0j*wNt[i] - 1.0*aux38*aux8*eta*u1j_udNx2j*wNt[i] - 1.0*aux38*aux8*eta*u2j_udNx1j*wNt[i];
    F[3*i + 0] += scale * ( __Fi[0] );
    F[3*i + 1] += scale * ( __Fi[1] );
    F[3*i + 2] += scale * ( __Fi[2] );
  }
