                                           ...
                                           PetscScalar Y[])
{
  ...
  if (form->type != FORM_SPMV && form->type != FORM_RESIDUAL) SETERRQ(comm,PETSC_ERR_USER,"Form type must be FORM_SPMV or FORM_RESIDUAL. Found %" PetscInt_FMT "",(PetscInt)form->type);
                                    ...
                                    Mat A)
{
  ...
  if (form->type != FORM_ASSEMBLE) SETERRQ(comm,PETSC_ERR_USER,"Form type must be FORM_ASSEMBLE. Found %" PetscInt_FMT "",(PetscInt)form->type);
                                      ...
                                      Vec diagA)
{
  ...
  if (form->type != FORM_ASSEMBLE_DIAG) SETERRQ(comm,PETSC_ERR_USER,"Form type must be FORM_ASSEMBLE_DIAG. Found %" PetscInt_FMT "",(PetscInt)form->type);
