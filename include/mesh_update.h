...
PetscErrorCode UpdateMeshGeometry_ApplyDiffusionJMAX_BaseLevel(DM dav, PetscReal *diffusivities, PetscReal baselvl,PetscReal timespan,PetscBool dirichlet_east,PetscBool dirichlet_west,PetscBool dirichlet_front,PetscBool dirichlet_back,PetscBool only_update_surface);
